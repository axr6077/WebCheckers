...
public class WebServer {
  ...
  public static final String REPLAYPREVIOUS_URL = "/replay/previousTurn";
  ...
  public void initialize() {
    ...
    get(HOME_URL, new GetHomeRoute(playerLobby,templateEngine, gameCenter));
    ...
    post(CHECKTURN_URL, new PostCheckTurnRoute(gson, gameCenter));
    ...
    get(REPLAYGAME_URL, new GetReplayRoute(gson, gameCenter, templateEngine));
    get(REPLAYSTOP_URL, new GetReplayStopRoute(gson, gameCenter));
    post(REPLAYNEXT_URL, new PostReplayNextTurnRoute(gson, gameCenter));
    post(REPLAYPREVIOUS_URL, new PostReplayPrevTurnRoute(gson, gameCenter));
