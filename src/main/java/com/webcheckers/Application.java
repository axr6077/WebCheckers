...
public final class Application {
  ...
  public static void main(String[] args) {
    ...
    //add bots to lobby
    playerLobby.addPlayer(new Player(playerLobby.REDBOT, true));
    playerLobby.addPlayer(new Player(playerLobby.WHITEBOT, true));

    // inject the game center and freemarker engine into web server
    final WebServer webServer = new WebServer(templateEngine, gson, playerLobby, center);
